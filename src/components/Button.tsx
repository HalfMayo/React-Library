...
export default function Button({color = "primary", rank = "default", label, onClick, disabled = false, type, className} : ButtonProps) {
    return(
        <button type={type} className={`${className} py-2 px-3 w-fit text-sm font-medium border rounded-full
                            ${disabled
