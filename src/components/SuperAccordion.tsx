...
export default function SuperAccordion({infos, width = "600px", compressed = false, className, bgMainTitle, bgInnerTitle, bgInnerText}: SuperAccordionProps) {
        ...
        <ul className={className} style={{width: `${width}`}}>
            {
                infos.map((info, i) =>
                    ...
                    : <SuperToggle key={i}
                        ...
                        width="100%"
                        bgMainTitle={bgMainTitle}
                        bgInnerTitle={bgInnerTitle}
                        bgInnerText={bgInnerText}
                        />
                )
            }
        </ul>
